...
window.angular.module('myApp.controllers', []).controller('MainController', function($scope, $location, MtpApiManager, CryptoWorker, $timeout) {
  ...
  this.download_messages = function() {
    var ids;
  ...
  this.download_first_media = function() {
    var biggest, message;
  ...
  this.download_file_without_location = function(id, data_obj) {
    var ext, file, loc;
  ...
  this.download_next_media = function() {
    _this.progress_current++;
    return _this.download_first_media();
  };
  this.download_json = function() {
    var zip;
  ...
  this.open_database = function(user) {
